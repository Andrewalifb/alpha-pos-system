...
func main() {
	...
	inventoryHistorySvc := service.NewPosInventoryHistoryService(inventoryHistoryRepo)
	productSvc := service.NewPosProductService(productRepo)
	promotionSvc := service.NewPosPromotionService(promotionRepo)
	productSubCategorySvc := service.NewPosProductSubCategoryService(productSubCategoryRepo)
