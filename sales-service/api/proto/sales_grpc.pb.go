...
type PosSaleServiceClient interface {
	CreatePosSale(ctx context.Context, in *CreatePosSaleRequest, opts ...grpc.CallOption) (*CreatePosSaleResponse, error)
...
func (c *posSaleServiceClient) CreatePosSale(ctx context.Context, in *CreatePosSaleRequest, opts ...grpc.CallOption) (*CreatePosSaleResponse, error) {
	out := new(CreatePosSaleResponse)
	err := c.cc.Invoke(ctx, "/pos.PosSaleService/CreatePosSale", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PosSaleServiceServer interface {
	CreatePosSale(context.Context, *CreatePosSaleRequest) (*CreatePosSaleResponse, error)
...
func (UnimplementedPosSaleServiceServer) CreatePosSale(context.Context, *CreatePosSaleRequest) (*CreatePosSaleResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreatePosSale not implemented")
}
...
func _PosSaleService_CreatePosSale_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreatePosSaleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PosSaleServiceServer).CreatePosSale(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pos.PosSaleService/CreatePosSale",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PosSaleServiceServer).CreatePosSale(ctx, req.(*CreatePosSaleRequest))
	}
...
var PosSaleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreatePosSale",
			Handler:    _PosSaleService_CreatePosSale_Handler,
		},
		{
